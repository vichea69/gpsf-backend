...
export class AddAnnualReportsToSectionsBlocktypeEnum1772302000000 implements MigrationInterface {
  name = 'AddAnnualReportsToSectionsBlocktypeEnum1772302000000';
      ...
      BEGIN
        IF EXISTS (
          ...
          WHERE t.typname = 'sections_blocktype_enum'
            ...
            AND e.enumlabel = 'annual_reports'
        ) THEN
          ALTER TYPE "public"."sections_blocktype_enum" ADD VALUE 'annual_reports';
        END IF;
      END $$;
    `);
  }
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF EXISTS (
          ...
          USING CASE
            WHEN "blockType"::text = 'annual_reports' THEN 'text_block'::"public"."sections_blocktype_enum"
